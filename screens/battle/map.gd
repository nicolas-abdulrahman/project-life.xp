...
@onready var game_handler: GameHandler = get_parent()
var entities_map: Dictionary[Vector2i, Entity] = {}
...
func add_entity(pos, entity):
	entity.animation.play("Idle")
	entity.position = adjust_height(map_to_local(pos))

	entities_map[pos]= entity
func adjust_height(pos: Vector2)-> Vector2:
...
func _on_entity_click(entity: Entity):
	...
	add_entity(selected_tile, entity)
